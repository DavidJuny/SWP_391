                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    ...
                                    <button onclick="window.location.href = './CreateCourseForm.jsp'" class="btn btn-primary" style="color: white;">Add Course</button>
                                </div>
                            </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Course Image</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Course Level</th>
                                        ...
                                        <tbody>
                                            ...
                                            <form action="CourseController" method="post" >
                                                <tr>
                                                        ...
                                                        <div class="d-flex px-2 py-1">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm">
                                                                    ...
                                                                    <p class="text-xs font-weight-bold mb-0">${course.courseID}</p>
                                                                </h6>
                                                    ...
                                                    <td>
                                                        <input type="text" name="courseName" class="text-xs font-weight-bold mb-0" value="${course.courseName}">
                                                    </td>
                                                    ...
                                                    <td class="align-middle">
                                                        ...
                                                        <button class="text-secondary font-weight-bold text-xs" type="submit" name ="action" value="DeleteCourse">
                                                            Delete
                                                        </button>
                                                    </td>
                                                </tr>

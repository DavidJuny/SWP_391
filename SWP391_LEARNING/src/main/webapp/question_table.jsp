        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              ...
              <button onclick="window.location.href = './CreateQuestionForm.jsp'" class="btn btn-primary" style="color: white;">Add Question</button>
            </div>
          </div>
            ...
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                ...
                <tr>
                  ...
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Lesson Item</th>
                ...
                <c:forEach var="question" items="${questions}">
                  <form action="AdminQuestionController" method="post" >
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">
                              ...
                              <p class="text-xs font-weight-bold mb-0">${question.questionID}</p>
                            </h6>
                      ...
                      <td>
                        <input type="text" name="lessonItemID" class="text-xs font-weight-bold mb-0" value="${question.typeID}">
                      </td>
                      <td class="align-middle text-center">
                        <input type="text" class="text-secondary text-xs font-weight-bold" name="question" value = "${question.question}">
                      </td>
                      <td class="align-middle text-center">
                        <input type="text" class="text-secondary text-xs font-weight-bold" name="answer" value = "${question.answer}">
                      </td>
                      <td class="align-middle">
                        <button class="text-secondary font-weight-bold text-xs" type="submit" name ="action" value="UpdateQuestion">
                          Edit
                        </button>
                        <button class="text-secondary font-weight-bold text-xs" type="submit" name ="action" value="DeleteQuestion">
                          Delete
                        </button>
                      </td>
                    </tr>

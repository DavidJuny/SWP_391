...
<%
    ...
    ArrayList<course> courses = courseDAO.GetCourses(); // Replace with your logic to retrieve the courses
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Topic table</h6>
                            <button onclick="redirectToCreateTopicForm()" class="btn btn-primary" style="color: white;">Add Topic</button>
                        </div>
                    </div>
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Topic ID</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Topic Name</th>
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Topic Image</th>
                                ...
                                <c:forEach var="topic" items="${topics}">
                                    <form action="TopicController" method="post" >
                                        <tr>
                                                ...
                                                <div class="d-flex px-2 py-1">
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">
                                                            ...
                                                            <p class="text-xs font-weight-bold mb-0">${topic.topicID}</p>
                                                        </h6>
                                            ...
                                            <td>
                                                <input type="text" name="topicName" class="text-xs font-weight-bold mb-0" value="${topic.topicName}">
                                            </td>
                                            <td class="align-middle text-center text-sm">

                                                <img src="${topic.topicImage}">
                                                <input type="file" name="topicImage" value="${topic.topicImage}" accept="image/*">
                                            </td>
                                            <td class="align-middle text-center">
                                                <input type="text" class="text-secondary text-xs font-weight-bold" name="courseID" value = "${topic.courseID}">
                                            </td>
                                            <td class="align-middle">
                                                <button class="text-secondary font-weight-bold text-xs" type="submit" name ="action" value="UpdateTopic">
                                                    Edit
                                                </button>
                                                <button class="text-secondary font-weight-bold text-xs" type="submit" name ="action" value="DeleteTopic">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
...
<script>
    function redirectToCreateTopicForm() {
        window.location.href = './CreateTopicForm.jsp';
    }
</script>

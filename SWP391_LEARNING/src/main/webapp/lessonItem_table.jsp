...
<%
  ...
  ArrayList<lesson> lessons = lessonDAO.GetAllLesson(); // Replace with your logic to retrieve the courses
        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3">Lesson Item table</h6>
              <button onclick="window.location.href = './CreateLessonItemForm.jsp'" class="btn btn-primary" style="color: white;">Add Lesson Item</button>
            </div>
          </div>
          <div class="card-body px-0 pb-2">
            <div class="table-responsive p-0">
              <table class="table align-items-center mb-0">
                <thead>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">LessonItem ID</th>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Lesson ID</th>
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">ItemType ID</th>
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Content</th>
                  <th class="text-secondary opacity-7"></th>
                </tr>
                <tbody>
                <c:forEach var="lessonItem" items="${lessonItems}">
                  <form action="AdminLessonItemController" method="post" >
                    <tr>
                        ...
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">
                              ...
                              <p class="text-xs font-weight-bold mb-0">${lessonItem.lessonItemID}</p>
                            </h6>
                      ...
                      <td>
                        <input type="text" name="lessonID" class="text-xs font-weight-bold mb-0" value="${lessonItem.lessonID}">
                      </td>
                      <td class="align-middle text-center">
                        <input type="text" class="text-secondary text-xs font-weight-bold" name="itemTypeID" value = "${lessonItem.itemTypeID}">
                      </td>
                      <td class="align-middle text-center">
                        <input type="text" class="text-secondary text-xs font-weight-bold" name="content" value = "${lessonItem.content}">
                      </td>
                      <td class="align-middle">
                        <button class="text-secondary font-weight-bold text-xs" type="submit" name ="action" value="UpdateLessonItem">
                          Edit
                        </button>
                        <button class="text-secondary font-weight-bold text-xs" type="submit" name ="action" value="DeleteLessonItem">
                          Delete
                        </button>
                      </td>
                    </tr>

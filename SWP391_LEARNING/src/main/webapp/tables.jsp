                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Parent table</h6>
                                </div>
                            </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Parent Account</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Parent Name</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Parent Sex</th>
                                                        ...
                                                        <div class="d-flex px-2 py-1">
                                                            ...
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm">
                                                                    <p class="text-xs font-weight-bold mb-0">${parent.parentID}</p>
                                                                </h6>
                                                                <p class="text-xs font-weight-bold mb-0">${parent.parentPhone}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <input type="hidden" name="parentAccount" value="${parent.parentAccount}">
                                                        <p class="text-xs font-weight-bold mb-0">${parent.parentAccount}</p>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="badge badge-sm bg-gradient-success">${parent.parentName}</span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold">${parent.parentSex}</span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold">${parent.account.status}</span>
                                                    </td>
                                                    <td class="align-middle">
                                                        <button class="text-secondary font-weight-bold text-xs" type="submit" name ="action" value="UpdateParent">
                                                            Edit
                                                        </button>
                                                    </td>
                                                </tr>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">Kids table</h6>
                                </div>
                            </div>
                            <div class="card-body px-0 pb-2">
                                <div class="table-responsive p-0">
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kid ID</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Kid Account</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kid Name</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Kid Birthday</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Status</th>
                                                <th class="text-secondary opacity-7"></th>
                                            </tr>
                                        </thead>
                                            ...
                                            <form action="AdminController" method="post">
                                                <tr>
                                                    <td>
                                                        <div class="d-flex px-2 py-1">
                                                            <div>
                                                                <img src="${kid.kidImage}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                                                            </div>
                                                            <div class="d-flex flex-column justify-content-center">
                                                                <h6 class="mb-0 text-sm">
                                                                    ${kid.kidID}
                                                                </h6>
                                                                <p class="text-xs font-weight-bold mb-0">${kid.parentID}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <input type="hidden" name="kidAccount" value="${kid.kidAccount}">
                                                        <p class="text-xs font-weight-bold mb-0">${kid.kidAccount}</p>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span class="badge badge-sm bg-gradient-success">${kid.kidName}</span>
                                                    </td>
                                                    <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold">${kid.kidBrithday}</span>
                                                    </td> <td class="align-middle text-center">
                                                        <span class="text-secondary text-xs font-weight-bold">${kid.account.status}</span>
                                                    </td>
                                                    <td class="align-middle">
                                                        <button class="text-secondary font-weight-bold text-xs" type="submit" name ="action" value="UpdateKid">
                                                            Edit
                                                        </button>
                                                    </td>
                                                </tr>
        ...
        <script>
            function searchTable() {
                ...
                for (i = 0; i < tr.length; i++) {
                    td = tr[i].getElementsByTagName("td")[2]; // Index 2 corresponds to the "Parent Name" column
                    if (td) {
            ...
            // Attach the searchTable function to the "keyup" event of the search input

...
public class LessonItemController extends HttpServlet {
    ...
    private static final String VIEW = "leaning.jsp"; // trang nay hien thi cac lessonItem cua mot Lesson de kid co the lua chon ma bat dau hoc Item nao truoc
    private static final String STUDY = "real_learning.jsp"; // trang hien content cua lessonItem sau khi kid da chon Item de hoc

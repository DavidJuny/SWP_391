...
//                     String remember = request.getParameter("remember");
                     ...
                     kidDAO.getAllKids();
                     if (kidDAO.checkIfExistedAccount(username, password)) {
                            kid kidAcc = kidDAO.kcheckLogin(username, password);
                            if (kidAcc != null) {
...
//                            response.addCookie(cookieRemember);
                     ...
                     } else if (parentDAO.checkIfExistedAccount(username, password)) {

...
public class PaymentController extends HttpServlet {
       ...
       protected void processRequest(HttpServletRequest request, HttpServletResponse response)
              ...
              try {
                     ...
                     String kidID = request.getParameter("kidID"); // lay ben trang payment.jsp cho phep parent lua chon kid theo ten de mua khoa hoc cho.
                     if (proDAO.checkStatusKidLearning(kidID, courseID)) {
                            ...
                            paymentDAO.AddDetailPayment(paymentID, courseID, ammountCourse, formattedDate, "Pending");
